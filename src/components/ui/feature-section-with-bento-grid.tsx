...
import { featureIcons } from "@/components/features/feature-colors";
import { ReactNode } from "react";
import { ArrowRightIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import { Button } from "@/components/ui/button";

// Bento Grid component for feature layout
const BentoGrid = ({
  children,
  className,
}: {
...
// Bento Card component for individual features
const BentoCard = ({
  name,
  className,
  background,
...
// Main Feature component that can be imported and used directly
